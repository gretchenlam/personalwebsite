...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_fkb3khe', 'template_ssk7fds', form.current, '2LEJz9AFyt3w0VjZY');
        e.target.reset();
    };
                    ...
                    <div className="contact__content">
                        ...
                        <div className="contact__info">
                            <div className="contact__card">
                                ...
                                <span className="contact__card-data">gretchenlam03@gmail.com</span>
                                <a href="mailto:gretchenlam03@gmail.com" className="contact__button">
                                    write me{" "}
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea name="project" cols="30" rows="10" className="contact__form-input" placeholder="enter message details..."></textarea>
                        </div>
